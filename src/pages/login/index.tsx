...
export function Login() {
    ...
    function hanbleSubmit(e: FormEvent){
      e.preventDefault();
    ...
    return (
        <div className="flex w-full h-screen items-center justify-center flex-col">
            ...
            <form onSubmit={hanbleSubmit} className="w-full max-w-xl flex flex-col px-2">
                ...
                <button
                 ...
                 rounded border-0 text-lg font-medium text-white">
                    Acessar
                </button>
            </form>
        </div>
